...
public class OrderInfo {
	...
	public String toString() {
		return "OrderInfo [appid=" + appid + ", attach=" + attach + ", body=" + body + ", mch_id=" + mch_id
				+ ", nonce_str=" + nonce_str + ", notify_url=" + notify_url + ", openid=" + openid + ", out_trade_no="
				+ out_trade_no + ", sign=" + sign + ", sign_type=" + sign_type + ", spbill_create_ip="
