...
public class XmlPayResultInfo {
	...
	public String toString() {
		return "XmlPayResultInfo [orderId=" + orderId + ", return_code=" + return_code + ", return_msg=" + return_msg
				+ ", appid=" + appid + ", mch_id=" + mch_id + ", device_info=" + device_info + ", nonce_str="
				+ nonce_str + ", sign=" + sign + ", sign_type=" + sign_type + ", result_code=" + result_code
				+ ", err_code=" + err_code + ", err_code_des=" + err_code_des + ", openid=" + openid + ", is_subscribe="
				+ is_subscribe + ", trade_type=" + trade_type + ", bank_type=" + bank_type + ", total_fee=" + total_fee
				...
				+ ", coupon_type_0=" + coupon_type_0 + ", coupon_type_1=" + coupon_type_1 + ", coupon_type_2="
				+ coupon_type_2 + ", coupon_type_3=" + coupon_type_3 + ", coupon_id_0=" + coupon_id_0 + ", coupon_id_1="
				+ coupon_id_1 + ", coupon_id_2=" + coupon_id_2 + ", coupon_id_3=" + coupon_id_3 + ", coupon_fee_0="
				+ coupon_fee_0 + ", coupon_fee_1=" + coupon_fee_1 + ", coupon_fee_2=" + coupon_fee_2 + ", coupon_fee_3="
				+ coupon_fee_3 + ", transaction_id=" + transaction_id + ", out_trade_no=" + out_trade_no + ", attach="
